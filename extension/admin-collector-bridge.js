(() => {
  ...
  if (window.location.origin !== "https://pricetrackph.com" || window.location.pathname !== "/admin/collector") return;
  ...
  window.addEventListener("message", (event) => {
    ...
    if (message?.source !== PAGE_SOURCE || message?.type !== "start"
      || !UUID_V4.test(String(message.scanId || "")) || !validStoreUrl(message.storeUrl)) return;
