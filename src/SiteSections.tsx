...
function SiteSections() {
  ...
  const isAdminPage = ["/admin", "/admin/", "/admin/health", "/admin/health/", "/admin/affiliate", "/admin/affiliate/", "/admin/monitoring", "/admin/monitoring/"].includes(window.location.pathname);
