-- Preserve both collector scheduling toggles in the final mark_product_check definition.
  ...
  set last_check_attempt_at = p_checked_at,
      ...
      next_check_at = case
        ...
        when p_status = 'success' and v_all_sold_out and v_skip_sold_out and v_already_successful_today then
          next_check_at
        when p_status = 'success' and v_all_sold_out and v_skip_sold_out and consecutive_sold_out_checks >= 2 then
