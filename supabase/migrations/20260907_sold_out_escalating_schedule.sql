-- Keep the first two consecutive sold-out rechecks at 15 days, then
-- reduce repeated checks to once every 30 days until stock returns.
...
set consecutive_sold_out_checks = 1
where all_variations_sold_out is true
  and consecutive_sold_out_checks = 0;
